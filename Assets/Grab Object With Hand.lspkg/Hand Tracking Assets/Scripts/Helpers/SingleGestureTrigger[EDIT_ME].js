...
function setUpTracking() {
    ...
    if (hand) {
        checkLength = hand.checkLength;
        getDistance = hand.getJointsDistance;
        //getJointsAveragePosition = hand.getJointsAveragePosition;
    }
}
...
function getTracking() {
    switch (script.handType) {
        case HAND_TYPE.ANY:
            ...
            break;
        case HAND_TYPE.LEFT:
            if (global.leftHand() && global.leftHand().isTracking) {
                isHandTracking = global.leftHand().isTracking();
                handString = "L: ";
            }
            break;
        case HAND_TYPE.RIGHT:
            if (global.rightHand() && global.rightHand().isTracking) {
                isHandTracking = global.rightHand().isTracking();
                handString = "R: ";
            }
            break;
    }
