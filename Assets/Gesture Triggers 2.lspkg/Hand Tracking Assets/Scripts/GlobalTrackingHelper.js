...
global.getActiveHandController = function() {
    if (global.leftHand().isTracking()) {
        return script.leftHandTrackingScript;
    }
    if (global.rightHand().isTracking()) {
...
global.getJoint = function(jName) {
    if (global.getActiveHandController()) {
        return global.getActiveHandController().getJoint(jName);
    } else {
        return null;
    }
};
...
global.getJointsDistance = function(jArray1, jArray2) {
    if (global.getActiveHandController()) {
        return global.getActiveHandController().getJointsDistance(jArray1, jArray2);
    } else {
        return null;
    }
};
...
global.showJointsStats = function(jointNames, axis) {
    if (global.getActiveHandController()) {
        return global.getActiveHandController().showJointsStats(jointNames, axis);
    } else {
        return null;
    }
};
...
global.checkJointAngles = function(jointArray, min, max, axis) {
    if (global.getActiveHandController()) {
        return global.getActiveHandController().checkJointAngles(jointArray, min, max, axis);
    } else {
        return null;
    }
};
...
global.checkLength = function(lengthArray, min, max) {
    if (global.getActiveHandController()) {
        return global.getActiveHandController().checkLength(lengthArray, min, max);
    } else {
        return null;
    }
};
...
global.getJointsAveragePosition = function(jointNames) {
    if (global.getActiveHandController()) {
        return global.getActiveHandController().getJointsAveragePosition(jointNames);
    } else {
        return null;
    }
};
...
global.getJointsAverageWorldRotation = function(jointNames) {
    if (global.getActiveHandController()) {
        return global.getActiveHandController().getJointsAverageWorldRotation(jointNames);
    } else {
        return null;
    }
};
...
global.getJointsAverageLocalRotation = function(jointNames) {
    if (global.getActiveHandController()) {
        return global.getActiveHandController().getJointsAverageLocalRotation(jointNames);
    } else {
        return null;
    }
};
...
global.getHandSizeOffset = function() {
    if (global.getActiveHandController()) {
        return global.getActiveHandController().getHandSizeOffset();
    } else {
        return null;
    }
};
