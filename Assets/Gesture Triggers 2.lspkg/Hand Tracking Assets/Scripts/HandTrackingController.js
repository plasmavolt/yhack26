...
script.getJoint = getJoint;
script.showJointsStats = showJointsStats;
script.getJointsDistance = getJointsDistance;
script.getJointsAveragePosition = getJointsAveragePosition;
script.getJointsAverageWorldRotation = getJointsAverageWorldRotation;
script.getJointsAverageLocalRotation = getJointsAverageLocalRotation;
script.getHandSizeOffset = getHandSizeOffset;
script.getJointAngle = getJointAngle;
script.checkJointAngles = checkJointAngles;
script.isTracking = isTracking;
script.checkLength = checkLength;