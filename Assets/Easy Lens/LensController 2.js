...
function onUpdate() {
    ...
    if (script.scratchBg) {
        if (scratchActive) {
            ...
            const h2 = (currentDeckHue + 30) % 360; // small offset for gradient separation
            // High saturation, medium-high brightness for vivid but readable bg
            const c1 = hsbToRgba01(h1, 0.95, 0.6, 1.0);
            const c3 = hsbToRgba01(h2, 0.95, 0.6, 1.0);
